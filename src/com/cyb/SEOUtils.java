...
//		doc.add(new Field("content",reader));
	...
	private static void searcher(String words,String field) throws CorruptIndexException,
			IOException, ParseException, org.apache.lucene.queryparser.classic.ParseException {
		File indexDir = new File(INDEX_DIR);
		//索引目录
		Directory dir=FSDirectory.open(indexDir);
		//根据索引目录创建读索引对象
	...
	public static void main(String[] args) throws IOException, ParseException,
			InterruptedException, ParserException, org.apache.lucene.queryparser.classic.ParseException {
