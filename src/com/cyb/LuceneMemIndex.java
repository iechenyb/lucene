...
public class LuceneMemIndex {  
    ...
    public static void addDoc(IndexWriter iw)  throws Exception{  
        ...
        for (File file : files) {  
            ...
            String content=LuceneMemIndex.getContent(file);  
    ...
    public static void start(String col,String words) throws Exception{
        ...
        LuceneMemIndex.search(query,words);  
    }
    public static void main(String[] args) throws Exception, Exception {  
    	//deleteIndex();
    	LuceneMemIndex.createIndex(analyzer);
    	String words = "开户";
    	String col ="name";
    	start(col,words);
    	System.out.println("----------------");
